...
const translations = {
  en: {
    ...
    serviceCompleteRenovationsDesc: 'Comprehensive management of renovations to transform your spaces with design, quality, and attention to detail.',
    serviceKitchenRenovations: 'Kitchen Renovations',
    serviceKitchenRenovationsDesc: 'Modern, practical, and functional kitchen designs and renovations tailored to your style.',
    serviceSpaceRedistribution: 'Space Redistribution',
    serviceSpaceRedistributionDesc: 'Interior reorganization to maximize space usage and enhance functionality.',
    serviceCustomTerraceDesign: 'Custom Terrace Design',
    serviceCustomTerraceDesignDesc: 'Unique terrace creations that combine aesthetics, comfort, and designs tailored to your needs.',
    servicePaintingFinishes: 'Painting and Finishes',
    servicePaintingFinishesDesc: 'Professional finishes that bring life and personality to every corner of your home.',
    serviceBathroomRenovations: 'Bathroom Renovations',
    serviceBathroomRenovationsDesc: 'Transforming bathrooms into modern, comfortable, and functional spaces.',
    serviceRoofsPergolas: 'Roofs and Pergolas',
    serviceRoofsPergolasDesc: 'Installation and design of roofs and pergolas for outdoor spaces that blend style and protection.',
  ...
  es: {
    ...
    serviceCompleteRenovationsDesc: 'Gestión integral de reformas para transformar tus espacios con diseño, calidad y atención al detalle.',
    serviceKitchenRenovations: 'Reformas de Cocinas',
    serviceKitchenRenovationsDesc: 'Diseños y reformas de cocinas modernas, prácticas y funcionales adaptadas a tu estilo.',
    serviceSpaceRedistribution: 'Redistribución de Espacios',
    serviceSpaceRedistributionDesc: 'Reorganización de interiores para maximizar el uso del espacio y mejorar la funcionalidad.',
    serviceCustomTerraceDesign: 'Diseño de Terrazas a Medida',
    serviceCustomTerraceDesignDesc: 'Creaciones de terrazas únicas que combinan estética, confort y diseños adaptados a tus necesidades.',
    servicePaintingFinishes: 'Pintura y Acabados',
    servicePaintingFinishesDesc: 'Acabados profesionales que aportan vida y personalidad a cada rincón de tu hogar.',
    serviceBathroomRenovations: 'Reformas de Baños',
    serviceBathroomRenovationsDesc: 'Transformación de baños en espacios modernos, cómodos y funcionales.',
    serviceRoofsPergolas: 'Techos y Pérgolas',
    serviceRoofsPergolasDesc: 'Instalación y diseño de techos y pérgolas para espacios exteriores que combinan estilo y protección.',
